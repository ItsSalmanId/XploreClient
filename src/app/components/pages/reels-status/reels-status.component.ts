...
@Component({
  selector: 'app-reels-status',
  templateUrl: './reels-status.component.html',
  styleUrls: ['./reels-status.component.scss']
})
export class ReelsStatusComponent implements OnInit {
